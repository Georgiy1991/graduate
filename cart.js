class Cart{
    ...
    createCart(){
        this.catalogCounter.addEventListener('click', function Cou(){
            cart.containerCart.style.display = 'block';
            let productsCart = cart.getProductCart();
            let wrapper = document.createElement('slot');
            let wrapperHead = document.createElement('div');
            wrapperHead.className = 'wrapper-head';
            wrapperHead.innerHTML = 'Товары в корзине:';
            ...
            cart.containerCart.appendChild(wrapperHead)
